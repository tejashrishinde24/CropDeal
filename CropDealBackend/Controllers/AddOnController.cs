...

{
...

    {
        ...
        public async Task<ActionResult> AddAddon([FromBody] AddOnVM addon)
        ...
        [HttpPut("Update-AddOn/{id}")]

        public async Task<IActionResult> UpdateAddon(int id, [FromBody] AddOnVM addon)
